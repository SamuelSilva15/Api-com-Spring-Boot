...
public class ProdutoServiceImplTest {
    ...
    public void deveBuscarTodosProdutos(){
        ...
        samsung.setValor(BigDecimal.valueOf(120));

        Produto iphone = new Produto();
        iphone.setId(2L);
        iphone.setNome("Iphone");
        iphone.setQuantidade(10);
        iphone.setValor(BigDecimal.valueOf(120));
    ...
    public void deveBuscarProdutoPorId() {
        ...
        produtoEsperado.setValor(BigDecimal.valueOf(120));
        ...
        Assert.assertEquals(20, produto.getQuantidade());
    }
    ...
    public void deveAtualizarPorId(){
        ...
        produtoAtualizado.setValor(BigDecimal.valueOf(12));
        ...
        Assert.assertEquals(BigDecimal.valueOf(12), captor.getValue().getValor());
        Assert.assertEquals(12, captor.getValue().getQuantidade());
